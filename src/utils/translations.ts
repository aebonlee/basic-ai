export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    footer: {
      tagline: 'AI 시대를 준비하는 체계적 인공지능 학습 플랫폼',
      companyInfo: '회사 정보',
      contact: '연락처',
      quickLinks: '바로가기'
    },
    shop: {
      title: '스토어',
      subtitle: 'AI 학습 교재, 온라인 강좌를 만나보세요',
      all: '전체',
      book: 'AI 도서',
      ebook: '전자출판',
      periodical: '간행물',
    ...
    site: {
      nav: {
        about: 'About',
        aboutIntro: 'About Basic AI',
        aboutRoadmap: 'Learning Roadmap',
        aboutHowToLearn: 'Study Guide',
        ...
        chatbot: '대화형 AI · ChatGPT · Claude',
        image: '이미지 생성 · DALL-E · MJ',
        voice: '음성 · 영상 AI',
        coding: 'AI Coding · Copilot · Cursor',
        ethics: 'AI Ethics',
        bias: 'AI 편향 & 공정성',
  ...
  en: {
    ...
    footer: {
      tagline: 'A systematic AI learning platform to prepare for the AI era',
    ...
    shop: {
      title: 'Store',
      subtitle: 'Explore AI learning materials and online courses',
      all: 'All',
      book: 'AI Books',
      ebook: 'E-Publishing',
    ...
    search: {
      ...
      hint: 'Search AI learning content.',
      blog: 'Blog',
      board: 'Board',
      gallery: 'Gallery'
    },
